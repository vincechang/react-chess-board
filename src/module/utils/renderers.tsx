...
import {
  PreviewPieceView,
  PreviewPieceViewProps,
} from '../views/PreviewPieceView'
...
import Threat, { ThreatProps } from '../dnd/Threat'

export type BoardRenderer = (props: RenderBoardViewProps) => React.ReactNode
export const defaultRenderBoard: BoardRenderer = ({
  children,
  resizeListener,
  ...props
}) => (
...
export const defaultRenderSquare: SquareRenderer = ({
  Coordinate,
  Piece,
  ...props
}) => (
...
export const defaultRenderPiece: PieceRenderer = (props) => (
  <PieceView {...props} />
)

export type CoordinateRenderer = (props: CoordinateViewProps) => React.ReactNode
export const defaultRenderCoordinate: CoordinateRenderer = (props) => (
  <CoordinateView {...props} />
)

export type PreviewPieceRenderer = (
  props: PreviewPieceViewProps,
) => React.ReactNode
export const defaultRenderPreviewPiece: PreviewPieceRenderer = (props) => (
  <PreviewPieceView {...props} />
)

export type DroppableSquareRenderer = (
  props: DroppableSquareProps,
) => React.ReactNode
export const defaultRenderDroppableSquare: DroppableSquareRenderer = (
  props,
) => <DroppableSquare {...props} />

export type DraggablePieceRenderer = (
...
export type ThreatRenderer = (props: ThreatProps) => React.ReactNode
export const defaultRnederThreat: ThreatRenderer = (props) => (
  <Threat {...props} />
)
...
export const mergeBoardRenderers: (
  ...
  renderThreat = defaultRnederThreat,
}) => ({
  renderBoard,
  renderSquare,
  renderPiece,
...
export interface SquareRenderingProps
